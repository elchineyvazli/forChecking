...
const NavbarMiddle = ({ signInValue = "Müricət et", translateXValue, closeFunction }) => {
    ...
    // const [openingMenuHover, setOpeningMenuHover] = useState(false)
    ...
    return (
        <div className="middle" style={{
            ...
            <div className="navbarLinks">
                ...
                <Link className="links akademiyaLink" to="/akademiya"
                // onMouseEnter={() => setOpeningMenuHover(true)}
                // onMouseLeave={() => setOpeningMenuHover(false)}
                >Akademiya
                    <button onClick={""} className='openingMenuButton'><AiOutlineDown size={15} color='white' /></button>
                    {/* <div
                        className="openingMenu"

                        style={{
                            display: openingMenuHover
                                ? "hover"
                                : "none"
                        }}
                    >
